...
public class ASAttributeRegistry {
    ...
    // Mana Steal
    public static final DeferredHolder<Attribute, Attribute> MANA_STEAL = registerAttribute("mana_steal", 0.0D, -100, 100.0D);

    // Mana Rend
    public static final DeferredHolder<Attribute, Attribute> MANA_REND = registerAttribute("mana_rend", 0.0D, -100, 100.0D);
    ...
    private static DeferredHolder<Attribute, Attribute> registerAttribute(String id, double defaultVal, double minVal, double maxVal)
    {
