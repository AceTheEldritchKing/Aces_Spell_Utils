...
public final class ImpactFrameEffect {
    ...
    public static void trigger(int brightColor, int darkColor, float intensity, int durationTicks) {
        TIMELINE.start(brightColor, darkColor, intensity, durationTicks);
    }
